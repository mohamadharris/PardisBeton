...
$(function () {
    ...
    submitBtn.on("click", function (e) {
        ...
        ValidateNotEmptyInput(userName, "لطفاً نامتان را وارد نمایید");
        ValidateNotEmptyInput(userEmail, "لطفاً ایمیلتان را وارد نمایید");
        ValidateNotEmptyInput(msgSubject, "لطفاً موضوع را وارد نمایید");
        ValidateNotEmptyInput(msgText, "لطفاً پیامتان را وارد نمایید");
        ...
        if (isValidInput && isValidEmail) {
            $.ajax({
                ...
                success: function (data) {
                    $(".done-msg")
                        .text("سپاسگزاریم، پیامتان با موفقیت ارسال شد.")
                        .toggleClass("show");
                    setTimeout(function () {
